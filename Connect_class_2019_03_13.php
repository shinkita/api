    ...
    public function iospushnotification($fields)
    {
        ...
        switch ($fields['data']['noti_type']) {
            case 'friend_request_receive':
                $fields['notification']['title'] = $fields['data']['user_name'];$fields['notification']['body'] = $fields['data']['user_name']." Wants you to join the realm ".$fields['data']['profile_type']." network.";
                break;
            case 'updated_status':
