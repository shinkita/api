...
if($_SERVER['REQUEST_METHOD']=='POST')
{
  ...
  $data = array(
        ...
        'join'=>"JOIN event_module_attand ON event_module_attand.event_id=event_module.id JOIN user_detail ON event_module.user_id=user_detail.user_id JOIN profile_pic ON event_module.user_id=profile_pic.user_id AND profile_pic.profile_type=3",
        'where'=>'event_module_attand.user_id="'.$user_id.'" ORDER BY id DESC LIMIT 40 ',
      );
