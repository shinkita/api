...
Class db_connect {
        ...
        if ($mysql = $this->conn->query($query)) {
            ...
            if ($mysql->num_rows > 0) {
                while ($row = $mysql->fetch_assoc()) {
                    ...
                    $row['is_friend'] = 0;
                    $row['is_faimily'] = 0;
					$row['is_professional'] = 0;
                    if ($msql->num_rows > 0) {
                        $friend = $msql->fetch_all();
                        $que1 = "SELECT id,profile_type FROM friends_list WHERE (user_id = '$user_id' OR friends_id = '$user_id') AND (user_id = '$row[user_id]' OR friends_id = '$row[user_id]') AND approved=1  AND profile_type=2";
						  $msql1 = $this->conn->query($que1);
						 if ($msql1->num_rows > 0) {
							 $row['is_faimily'] = 1;
						 }
					  $que2 = "SELECT id,profile_type FROM friends_list WHERE (user_id = '$user_id' OR friends_id = '$user_id') AND (user_id = '$row[user_id]' OR friends_id = '$row[user_id]') AND approved=1  AND profile_type=3";
						  $msql2 = $this->conn->query($que2);
						 if ($msql2->num_rows > 0) {
							$row['is_professional'] = 1;
						 }
                        $row['is_friend'] = 1;
                    }
                    $rows[] = $row;
    ...
    public function iospushnotification($fields)
    {
       ...
       if($result[0]['type']!='')
        $post_type =$result[0]['type'];
        else
        $post_type ='';
        
       /* if(isset($result[0]['type']) && $result[0]['type'] != '')
        ...
        switch ($fields['data']['noti_type']) {
            case 'friend_request_receive':
                $fields['notification']['title'] = $fields['data']['user_name'];$fields['notification']['body'] = '';
				$fields['notification']['subtitle'] =$fields['data']['user_name']." Wants you to join the realm ".$fields['data']['profile_type']." network."; $fields['notification']['category'] = $fields['data']['noti_type'];
            ...
            case 'updated_status':
            $fields['notification']['title'] = $fields['data']['user_name'];$fields['notification']['body'] =  '';
				$fields['notification']['subtitle'] ="Shared a latest posting ".$post_type." in ".$fields['data']['profile_type']." network."; $fields['notification']['category'] = $fields['data']['noti_type'];
                $fields['notification']['content-available'] = 1;
                 $fields['notification']['mutable-content'] = 1;
                break;
            ...
            case 'share_location':
                $fields['notification']['title'] = $fields['data']['user_name'];$fields['notification']['body'] = '';
				$fields['notification']['subtitle'] =$fields['data']['user_name']." share location in ".$fields['data']['profile_type']." network"; $fields['notification']['category'] = $fields['data']['noti_type'];
                $fields['notification']['content-available'] = 1;
                 $fields['notification']['mutable-content'] = 1;
                break;
            case 'like_post':
                	$fields['notification']['title'] = $fields['data']['user_name'];$fields['notification']['body'] ='';
				$fields['notification']['subtitle'] ="Liked your ".$post_type." in the ".$fields['data']['profile_type']." network."; $fields['notification']['category'] = $fields['data']['noti_type'];
                $fields['notification']['content-available'] = 1;
                 $fields['notification']['mutable-content'] = 1;
                break;
            case 'comment_post':
			    ...
			    $fields['notification']['title'] = $fields['data']['user_name'];$fields['notification']['body'] = '';
				$fields['notification']['subtitle'] ="". "Remarked  on ".$post_type." in the ".$fields['data']['profile_type']." network.";$fields['notification']['category'] = $fields['data']['noti_type'];
                $fields['notification']['content-available'] = 1;
                 $fields['notification']['mutable-content'] = 1;
            ...
            case 'mention_comment':
			    ...
			    $fields['notification']['title'] = $fields['data']['user_name'];$fields['notification']['body'] ='';
				$fields['notification']['subtitle'] = "Describing the personal view on ".$fields['data']['user_name']." ".$post_type." in the ".$fields['data']['profile_type']." network.";$fields['notification']['category'] = $fields['data']['noti_type'];
                $fields['notification']['content-available'] = 1;
                 $fields['notification']['mutable-content'] = 1;
                break;
            case 'profile_pic_updated':
                $fields['notification']['title'] = $fields['data']['user_name'];$fields['notification']['body'] =''; 
				$fields['notification']['subtitle'] =" Updated the "."picture " ."in the ".$fields['data']['profile_type']." network.";$fields['notification']['category'] = $fields['data']['noti_type'];
                $fields['notification']['content-available'] = 1;
                 $fields['notification']['mutable-content'] = 1;
                break;
			   ...
			   case 'event_edited':
               $fields['notification']['title'] =$fields['data']['sender_name']; $fields['notification']['body'] ='';
               $fields['notification']['subtitle'] ="Posted latest information on the ". $fields['data']['event_title']." event. ";$fields['notification']['category'] = $fields['data']['noti_type'];
                $fields['notification']['content-available'] = 1;
                 $fields['notification']['mutable-content'] = 1;
               break;
			   case 'canceled_event':
               $fields['notification']['title'] =$fields['data']['sender_name']; $fields['notification']['body'] ='';
               $fields['notification']['subtitle'] ="Cancelled the ". $fields['data']['event_title']." event. ";$fields['notification']['category'] = $fields['data']['noti_type'];
                $fields['notification']['content-available'] = 1;
                 $fields['notification']['mutable-content'] = 1;
               break;
			   case 'invitation_accepted':
               $fields['notification']['title'] =$fields['data']['sender_name']; $fields['notification']['body'] ='';
               $fields['notification']['subtitle'] ="Accepted ". $fields['data']['event_title']." event. ";$fields['notification']['category'] = $fields['data']['noti_type'];
                $fields['notification']['content-available'] = 1;
                 $fields['notification']['mutable-content'] = 1;
               break;
			   case 'remind_invitation':
               $fields['notification']['title'] =$fields['data']['sender_name']; $fields['notification']['body'] ='';
               $fields['notification']['subtitle'] ="Sending you a reminder notice to join the ". $fields['data']['event_title']." event. ";$fields['notification']['category'] = $fields['data']['noti_type'];
                $fields['notification']['content-available'] = 1;
                 $fields['notification']['mutable-content'] = 1;
               break;
			   case 'friend_request_accept':
               $fields['notification']['title'] =$fields['data']['sender_name']; $fields['notification']['body'] ='';
               $fields['notification']['subtitle'] ="Accepted your Connection request in professional network.";$fields['notification']['category'] = $fields['data']['noti_type'];
                $fields['notification']['content-available'] = 1;
                 $fields['notification']['mutable-content'] = 1;
               break;
			   case 'friend_request_reject':
               $fields['notification']['title'] =$fields['data']['sender_name']; $fields['notification']['body'] ='';
               $fields['notification']['subtitle'] ="Rejected your Connection request in professional network .";$fields['notification']['category'] = $fields['data']['noti_type'];
                $fields['notification']['content-available'] = 1;
                 $fields['notification']['mutable-content'] = 1;
               break;
			   ...
			   default:
                $fields['notification']['title'] =$fields['data']['sender_name']; $fields['notification']['body'] ='';
               $fields['notification']['subtitle'] ="". $fields['data']['event_title']."";$fields['notification']['category'] = $fields['data']['noti_type'];
                $fields['notification']['content-available'] = 1;
                 $fields['notification']['mutable-content'] = 1;
               break;
        }
